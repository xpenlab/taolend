...
Objective: Verify collect fails when initiator is not registered
...
def main():
    ...
    print(f"{CYAN}Objective:{NC} Verify collect fails when initiator is not registered")
    print(f"{CYAN}Strategy:{NC} Attempt collect with unregistered user")
    ...
    # Find an OPEN loan that has passed MIN_LOAN_DURATION
    print_info("Finding an eligible OPEN loan...")
    ...
    if tx_receipt['status'] == 0:
        ...
        print_success("✓ Test PASSED: Collect correctly rejected unregistered user")
    else:
    ...
    print_success("✓ TC01 PASSED: Collect correctly rejects unregistered user")
