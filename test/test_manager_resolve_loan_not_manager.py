#!/usr/bin/env python3
"""
Test Case TC05-01: resolveLoan - Not Manager
Objective: Verify resolveLoan fails when called by non-manager
...
def main():
    print_section("Test Case TC05-01: resolveLoan - Not Manager")
    print(f"{CYAN}Objective:{NC} Verify resolveLoan fails when called by non-manager")
    print(f"{CYAN}Strategy:{NC} Non-manager (LENDER1) attempts to resolve a loan")
    ...
    test_loan_id = 1  # Dummy loan ID (doesn't need to exist)
    ...
    print_info("Not applicable - loan doesn't need to exist for access control test")

    # ========================================================================
    # Step 4: Execute Test Operation
    # ========================================================================
    print_section("Step 4: Execute Test Operation - Attempt resolveLoan")

    print_info(f"Calling resolveLoan as non-manager (LENDER1)...")
    print_info(f"Parameters: loanId={test_loan_id}, lenderAmount={test_lender_amount/1e9} TAO, borrowerAmount={test_borrower_amount/1e9} TAO")
    ...
    print_success("Non-manager cannot resolve loans")
